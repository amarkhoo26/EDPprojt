...
namespace EDPprojt {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public TableRow AddTableRow(int Id, string UserID, string Password) {
        ...
        public partial class TableRow : global::System.Data.DataRow {
            ...
            public string UserID {
                get {
                    try {
                        return ((string)(this[this.tableTable.UserIDColumn]));
                    }
...
namespace EDPprojt.DataSet1TableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table] WHERE (([Id] = @Original_Id) AND ((@IsNull_UserID = 1 A" +
                "ND [UserID] IS NULL) OR ([UserID] = @Original_UserID)) AND ((@IsNull_Password = " +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Id], [UserID], [Password]) VALUES (@Id, @UserID, @Pas" +
                "sword);\r\nSELECT Id, UserID, Password FROM [Table] WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [Id] = @Id, [UserID] = @UserID, [Password] = @Password WHERE (([Id] = @Original_Id) AND ((@IsNull_UserID = 1 AND [UserID] IS NULL) OR ([UserID] = @Original_UserID)) AND ((@IsNull_Password = 1 AND [Password] IS NULL) OR ([Password] = @Original_Password)));
SELECT Id, UserID, Password FROM [Table] WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::EDPprojt.Properties.Settings.Default.DbLogInConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, UserID, Password FROM dbo.[Table]";
        ...
        public virtual int Delete(int Original_Id, string Original_UserID, string Original_Password) {
        ...
        public virtual int Insert(int Id, string UserID, string Password) {
        ...
        public virtual int Update(int Id, string UserID, string Password, int Original_Id, string Original_UserID, string Original_Password) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string UserID, string Password, int Original_Id, string Original_UserID, string Original_Password) {
